...
<nav x-data="{ open: false }" class="bg-emerald-200 border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::check() && Auth::user()->user_types_id === 1)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('my-reservations')" :active="request()->routeIs('my-reservations')" wire:navigate>
                {{ __('My Reservations') }}
            </x-responsive-nav-link>
            
            @if (Auth::check() && Auth::user()->user_types_id === 1)
            <x-responsive-nav-link :href="route('admin.reservations')" :active="request()->routeIs('admin.reservations')" wire:navigate>
